(async () => {
    ...
    if (console.log("%c Josh/FroppyDog67 Blooket Hacks / Cheats %c\n	Modified by Josh/FroppyDog67-On on GitHub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star the github repo!%c  https://github.com/froppydog/blooketcheats.github.io", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
    ...
    let p,
        ...
        _ = l("div", {
            ...
            innerHTML: '<span style="text-shadow: 1px 1px rgb(0 0 0 / 40%); font-size: 0.8em;">Josh/FroppyDog67 Cheats<sup>v2.1</sup></span>'
        }, l("a", {
            className: "bigButton",
            style: {
                cursor: "pointer",
