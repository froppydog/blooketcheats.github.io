click Gui.js for the code for blooket cheats/hacks By josh/froppydog67 worked very hard for this code to work 
(async () => {
    ...
    if (console.log("%c Joshs/froppydog67 Blooket Hacks / Cheats %c\n	Modified by Josh/froppydog67 on GitHub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star the github repo!%c  (https://github.com/froppydog/blooketcheats.github.io)", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
    ...
    let c = {
        ...
        setItem(e, t) {
            return e.split(".").reduce((e, a, o, r) => (e[a] = (e[a] ? e[a] : {}), ++o == r.length && (e[a] = t), e[a]), this.data),
                localStorage.setItem("JoshGUISettings", JSON.stringify(this.data)),
                this.data
        },
        deleteItem(e) {
    ...
    try {
        for (let d of (c.data = JSON.parse(localStorage.getItem("JoshGUISettings") || "{}"), ["backgroundColor", "cheatList", "contentBackground", "defaultButton", "disabledButton", "enabledButton", "infoColor", "inputColor", "textColor"]))
    ...
    let p,
        ...
        _ = l("div", {
            ...
            innerHTML: '<span style="text-shadow: 1px 1px rgb(0 0 0 / 40%); font-size: 0.8em;">Joshs/froppydog67 Cheats<sup>v2.1</sup></span>'
        }, l("a", {
            className: "bigButton",
            style: {
                cursor: "pointer",
